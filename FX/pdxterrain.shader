	...
	MainCode PixelShader
	{
		...
		[[
			...
			PDX_MAIN
			{
				...
				float3 FinalColor = GameCalculateSunLighting( MaterialProps, LightingProps, Input.WorldSpacePos, IridescenceMask );
		...
		[[
			PDX_MAIN
			{
				...
				Diffuse = ApplyColorOverlay( Diffuse, ColorOverlay, saturate( PreLightingBlend ) );
					...
					#endif
					Diffuse = ApplyFogOfWar( Diffuse, Input.WorldSpacePos, FogOfWarAlpha );
